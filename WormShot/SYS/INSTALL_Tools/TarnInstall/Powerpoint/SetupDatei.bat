...
if /i "%cd%"=="C:\users\%username%\Wormshot\sys\install_tools\tarninstall\Powerpoint" exit

REM ExcelAufruf -- Immer Anpassen
start "powerpnt.exe" "EigentlichesDokument.pptx"
